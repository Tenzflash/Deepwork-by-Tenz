            ...
            <div className="w-full max-w-md space-y-8 bg-zinc-900/50 p-10 rounded-[2.5rem] border border-zinc-800 shadow-2xl">
                ...
                <div className="space-y-4">
                    ...
                    <div className="relative py-4">
                        ...
                        <div className="relative flex justify-center text-xs uppercase"><span className="bg-zinc-900/50 px-2 text-zinc-600 font-bold tracking-widest">Or email</span></div>
                    </div>
