...
// Next.js 15/16 requires searchParams to be treated as a Promise
                ...
                <div className="space-y-4">
                    ...
                    <div className="relative py-4">
                        ...
                        <div className="relative flex justify-center text-xs uppercase">
                            <span className="bg-zinc-900/50 px-2 text-zinc-600 font-bold tracking-widest">Or email</span>
                        </div>
                    </div>
